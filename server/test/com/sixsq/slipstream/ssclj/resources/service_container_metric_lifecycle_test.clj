(ns
  com.sixsq.slipstream.ssclj.resources.service-container-metric-lifecycle-test
  (:require
    ...
    [com.sixsq.slipstream.ssclj.resources.service-container-metric :as callback]
...
(deftest lifecycle
        ...
        (let [  tstart              "2019-08-25T10:00:00.0Z"
                tstop               "2019-08-25T11:00:00.1Z"
                create-test-callback{   :id             (str callback/resource-url "/example")
                                        :resourceURI    callback/resource-uri
                                        :acl            valid-acl
                                        :device_id      {:href "device/device-id"}
