(ns
  ...
  com.sixsq.slipstream.ssclj.resources.sla-template-lifecycle-test
  (:require
...
(def base-uri (str p/service-context (u/de-camelcase sla-template/resource-url)))
...
(deftest lifecycle
  (let [session       (-> (ltu/ring-app)
    ...
    (let [timestamp            "1964-08-25T10:00:00.0Z"
          ...
          client               {:id   "client-id"
                                :name "client-name"}
          create-test-callback {:id          (str callback/resource-url "/example-template")
