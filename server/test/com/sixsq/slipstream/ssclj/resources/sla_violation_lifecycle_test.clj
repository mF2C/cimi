(ns
  com.sixsq.slipstream.ssclj.resources.sla-violation-lifecycle-test
  (:require
    ...
    [com.sixsq.slipstream.ssclj.resources.sla-violation :as sla-violation]
    [com.sixsq.slipstream.ssclj.resources.lifecycle-test-utils :as ltu]
    [com.sixsq.slipstream.ssclj.resources.common.utils :as u]
    [com.sixsq.slipstream.ssclj.resources.common.schema :as c]
    [com.sixsq.slipstream.ssclj.resources.sla-violation :as callback]
    [com.sixsq.slipstream.ssclj.resources.example-resource.utils :as utils]))

(use-fixtures :each ltu/with-test-server-fixture)

(def base-uri (str p/service-context (u/de-camelcase sla-violation/resource-url)))
...
(deftest lifecycle
        ...
        (let [  timestamp               "1964-08-25T10:00:00.0Z"
                create-test-callback{   :id          (str callback/resource-url "/example-violation")
                                        :resourceURI callback/resource-uri
                                        :acl         valid-acl
                                        :created        timestamp
                                        :updated        timestamp
                                        :agreement_id   "agreement-id-01"
                                        :guarantee      "gt01"
                                        :datetime       timestamp
                                    }
