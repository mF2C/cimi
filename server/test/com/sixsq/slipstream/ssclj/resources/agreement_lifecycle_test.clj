(ns
  ...
  com.sixsq.slipstream.ssclj.resources.agreement-lifecycle-test
  (:require
    ...
    [com.sixsq.slipstream.ssclj.resources.agreement :as callback]
    [com.sixsq.slipstream.ssclj.resources.example-resource.utils :as utils]))

(use-fixtures :each ltu/with-test-server-fixture)

(def base-uri (str p/service-context (u/de-camelcase agreement/resource-url)))
...
(deftest lifecycle
        ...
        (let [  timestamp               "1964-08-25T10:00:00.0Z"
                ...
                client                  {   :id         "client-id"
                                            :name       "client-name"}
                    create-test-callback{   :id          (str callback/resource-url "/example-agreement")
