(ns
  com.sixsq.slipstream.ssclj.resources.service-container-metric
  (:require
...
(def validate-fn (u/create-spec-validation-fn :cimi/service-container-metric))
...
(defn initialize
  []
  (std-crud/initialize resource-url :cimi/service-container-metric))
