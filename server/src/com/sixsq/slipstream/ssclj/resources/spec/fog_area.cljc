...
(s/def :cimi.fog_area/id #{})               '''This ID correspond to the Fog area ID''' 
(s/def :cimi.fog_area/device_id #{})   			'''Getting input from Id table..this ID correspond to the leader ID of the fog area'''
(s/def :cimi.fog_area/created_on #{})
(s/def :cimi.fog_area/updated_on #{})
(s/def :cimi.fog_area/number_of_devices #{})           '''Total Number of Children agent (Normal Agent)'''
(s/def :cimi.fog_area/total_RAM_in_MBs #{})
(s/def :cimi.fog_area/top_device_RAM_in_MBs #{})
(s/def :cimi.fog_area/lowest_device_RAM_in_MBs #{})
(s/def :cimi.fog_area/total_storage_storage_in_MBs #{})
(s/def :cimi.fog_area/top_device_storage_in_MBs #{})
(s/def :cimi.fog_area/lowest_device_storage_in_MBs #{})
(s/def :cimi.fog_area/avg_processing_capacity_in_percentage #{})
(s/def :cimi.fog_area/top_device_CPU_in_percentage #{})
(s/def :cimi.fog_area/lowest_device_CPU_in_percentage #{})
(s/def :cimi.fog_area/avg_no_of_physical_CPU_cores #{})
(s/def :cimi.fog_area/top_device_CPU_physical_CPU_cores #{})
(s/def :cimi.fog_area/lowest_device_CPU_physical_CPU_cores #{})
(s/def :cimi.fog_area/avg_no_of_logical_CPU_cores #{})
(s/def :cimi.fog_area/top_device_CPU_logical_CPU_cores #{})
(s/def :cimi.fog_area/lowest_device_CPU_logical_CPU_cores #{})
(s/def :cimi.fog_area/avg_time_of_power_remaining_in_seconds #{})
(s/def :cimi.fog_area/top_device_with_highest_power_remaining_in_seconds #{})
(s/def :cimi.fog_area/lowest_device_with_lowest_power_remaining_in_seconds #{})
