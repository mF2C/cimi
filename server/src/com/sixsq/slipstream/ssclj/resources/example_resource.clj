...
(def ^:const resource-tag :exampleResources)

(def ^:const resource-name "ExampleResource")

(def ^:const resource-url (u/de-camelcase resource-name))

(def ^:const collection-name "ExampleResourceCollection")
...
;;
;; validate subclasses of example-resources
;;

(def validate-fn (u/create-spec-validation-fn :cimi/example-resource))
...
(defn initialize
  []
  (std-crud/initialize resource-url :cimi/example-resource))